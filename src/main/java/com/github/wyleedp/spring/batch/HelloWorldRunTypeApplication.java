...
public class HelloWorldRunTypeApplication {

	private Logger logger = LoggerFactory.getLogger(HelloWorldRunTypeApplication.class);
	...
	public static void main(String[] args) {
		SpringApplication application = new SpringApplication(HelloWorldRunTypeApplication.class);
		
		Properties properties = new Properties();
		
		// 어플리케이션 기동시 Job 미실행 처리
